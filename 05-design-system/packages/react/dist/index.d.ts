...
declare function ToastIgnite({ title, description, openModal, }: ToastProps): react_jsx_runtime.JSX.Element;
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, CheckBox, CheckBoxProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, ToastIgnite, ToastProps, Tooltip, TooltipProps, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
